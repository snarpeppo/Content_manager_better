...
Editor::inst( $db, 'content_x_submission_tag', [ 'fk_multimedia_format', 'fk_tag' ] )
	->fields(
			Field::inst( 'content_x_submission_tag.fk_multimedia_format' )
		...
		->leftJoin( 'content_submission', 'content_submission.pk_submission', '=', 'content_x_submission_tag.fk_multimedia_format' )
